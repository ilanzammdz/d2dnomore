...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-auto md:h-[60rem] lg:h-[80rem] flex items-center justify-center relative p-2 md:p-20"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl mx-auto h-[20rem] md:-mt-12 md:h-[30rem] lg:h-[40rem] w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
