...
const FOOTER_LINKS: { title: string; links: string[] }[] = [
  {
    title: "Services",
    links: ["Leak Repair", "Drain Cleaning", "Water Heaters", "Repiping", "Sump Pumps"],
  },
  {
    title: "Company",
    links: ["About Us", "Careers", "Reviews", "Blog"],
  },
  {
    title: "Resources",
    links: ["Emergency Guide", "Financing", "Warranty", "FAQ"],
  },
  {
    title: "Support",
    links: ["Contact Us", "Book Online", "24/7 Emergency Line"],
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          ...
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Pro Plumbers USA. All rights
            reserved.
          </p>
