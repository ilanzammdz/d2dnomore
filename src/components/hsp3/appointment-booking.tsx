...
import { Calendar } from "@/components/hsp3/ui/calendar";
import {
  Card,
  CardContent,
  CardFooter,
  CardHeader,
  CardTitle,
} from "@/components/hsp3/ui/card";
import { ScrollArea } from "@/components/hsp3/ui/scroll-area";
    ...
    <div>
      <Card className="gap-0 p-0">
        <CardHeader className="flex h-max justify-center border-b !p-4">
          <CardTitle>Schedule Your Service Call</CardTitle>
        </CardHeader>
        ...
        <CardFooter className="flex flex-col gap-4 border-t px-6 !py-5 md:flex-row">
          <div className="flex items-center gap-2 text-sm">
            {date && selectedTime ? (
              ...
              <>Select a date and time for your service call.</>
            )}
          </div>
          <Button
